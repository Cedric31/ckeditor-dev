...
CKEDITOR.lang[ 'oc' ] = {
	...
	common: {
		...
		editorHelp: 'Utilizatz l\'acorchi Alt-0 per obténer d\'ajuda',
		...
		targetParent: 'Fenèstra parenta (_parent)',
		langDirLTR: 'Esquèrra a dreita (LTR)',
		langDirRTL: 'Dreita a esquèrra (RTL)',
		styles: 'Estil',
		...
		invalidWidth: 'La largoor deu èsser un nombre.',
		invalidCssLength: 'La valor especificada pel camp « %1 » deu èsser un nombre positiu amb o sens unitat de mesura CSS valida (px, %, in, cm, mm, em, ex, pt, o pc).',
		invalidHtmlLength: 'La valor especificada pel camp « %1 » deu èsser un nombre positiu amb o sens unitat de mesura HTML valida (px o %).',
		invalidInlineStyle: 'La valeur especificada per l\'estil en linha deu èsser compausada d\'un o mantun parelhs al format « nom : valor », separats per de punts-virgulas.',
